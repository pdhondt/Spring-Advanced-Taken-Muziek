...
import be.vdab.muziek.clients.discogs.ReleaseClient;
import be.vdab.muziek.dto.Release;
import be.vdab.muziek.exceptions.ReleaseNietGevondenException;
...
public class ReleaseController {
    ...
    Release findById(@PathVariable long id) {
        return releaseClient.findById(id)
                .orElseThrow(ReleaseNietGevondenException::new);
    }
}
